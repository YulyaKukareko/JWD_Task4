 ...
 */
public class CountSentencesComparatorTest {

    @Test
    public void testSentencesCounter() {
        SortedMap<Integer, List<String>> expected = new TreeMap<>();
        ...
        Assert.assertEquals(expected, CountSentencesComparator.sentencesCounter(text.getElements()));
    }
}
